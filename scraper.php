...
foreach ($links as $link) {
  ...
  $node_author = $issue_page->filterXPath("///div[contains(string(@class), 'field-name-project-issue-created-by')]//a[@class = 'username']");
...
// Close "needs work" applications that got no update in more than 3 weeks.
